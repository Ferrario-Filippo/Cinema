			...
			{ data: "name", width: "20%" },
			{
				...
				render: function (data) {
					return `
						...
						<a href="/Admin/Hometown/Upsert?id=${data}" class="btn btn-primary mx-2">
							<i class="bi bi-pencil-square"></i>Modifica</a>
						<a onClick=Delete("/Admin/Hometown/Delete/${data}") class="btn btn-danger mx -2">
